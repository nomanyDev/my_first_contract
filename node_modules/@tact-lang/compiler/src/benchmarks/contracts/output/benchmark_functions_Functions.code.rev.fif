PROGRAM{
  ...
  recv_internal PROC:<{
    ...
    ROTREV
    ?fun_ref_8131162519805b39 INLINECALLDICT
    130 THROWIFNOT
    NEWC
    3 GETGLOBVAR
    s0 s1 XCHG
  ...
  get_abi_ipfs PROC:<{
    x{697066733A2F2F516D61705A3151774C4E375337484B615457706A335452526D44394A57644C726D31384A746B62635A6959596B4882_} PUSHSLICE
  }>
  ?fun_ref_2e8105a0f1ba34b1 PROCREF:<{
    ADD
  }>
  ?fun_ref_36266a5855831da9 PROCREF:<{
    c4 PUSH
    CTOS
    LDREF
    s0 s1 XCHG
  ...
  ?fun_ref_8131162519805b39 PROCREF:<{
    s0 s1 XCHG
    <{
      s0 POP
      -1 PUSHINT
