import { ASTExpression, ASTInitOf, ASTLvalueRef, ASTConditional } from "../grammar/ast";
...
export declare function resolveConditional(ast: ASTConditional, sctx: StatementContext, ctx: CompilerContext): CompilerContext;
