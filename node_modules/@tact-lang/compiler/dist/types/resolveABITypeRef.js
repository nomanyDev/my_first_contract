...
function resolveABIType(src) {
    if (src.type.kind === "type_ref_simple") {
        ...
        if (src.type.name === "Int") {
            if (src.as) {
                ...
                if (!fmt) {
                    (0, errors_1.throwCompilationError)(`Unsupported format ${src.as}`, src.ref);
                }
                return {
                    kind: "simple",
                    type: fmt.type,
        ...
        if (src.type.name === "StringBuilder") {
            (0, errors_1.throwCompilationError)(`Unsupported type "${src.type.name}"`, src.ref);
        }
        //
        // Structs
        //
    ...
    if (src.type.kind === "type_ref_map") {
        ...
        if (src.type.key === "Int") {
            ...
            if (src.type.keyAs) {
                ...
                if (!format) {
                    (0, errors_1.throwCompilationError)(`Unsupported format ${src.type.keyAs} for map key`, src.ref);
                }
                key = format.type;
            ...
            (0, errors_1.throwCompilationError)(`Unsupported map key type "${src.type.key}"`, src.ref);
        }
        // Resolve value type
        if (src.type.value === "Int") {
            ...
            if (src.type.valueAs) {
                ...
                if (!format) {
                    (0, errors_1.throwCompilationError)(`Unsupported format ${src.type.valueAs} for map value`, src.ref);
                }
                value = format.type;
            ...
            (0, errors_1.throwCompilationError)(`Unsupported map value type "${src.type.value}"`, src.ref);
        }
        ...
        else if (src.type.value === "StringBuilder" ||
    ...
    (0, errors_1.throwCompilationError)(`Unsupported type`, src.ref);
}
    ...
    if (src.kind === "map") {
        ...
        if (src.key === "Int") {
            ...
            if (src.keyAs) {
                ...
                if (!format) {
                    (0, errors_1.throwCompilationError)(`Unsupported format ${src.keyAs} for map key`, ref);
                }
                key = format.type;
                keyFormat = format.format;
            }
        ...
        if (src.value === "Int") {
            ...
            if (src.valueAs) {
                ...
                if (!format) {
                    (0, errors_1.throwCompilationError)(`Unsupported format ${src.valueAs} for map value`, ref);
                }
                value = format.type;
                valueFormat = format.format;
            }
