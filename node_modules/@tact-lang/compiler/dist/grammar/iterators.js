...
exports.foldStatements = exports.forEachStatement = exports.foldExpressions = exports.forEachExpression = void 0;
/**
 ...
 */
function forEachExpression(node, callback) {
 ...
 */
function foldExpressions(node, acc, callback) {
    function traverseExpression(acc, expr) {
    ...
    function traverseStatement(acc, stmt) {
        switch (stmt.kind) {
            case "statement_let":
            case "statement_assign":
            case "statement_augmentedassign":
            ...
            case "statement_condition":
                ...
                if (stmt.elseif)
                    acc = traverseStatement(acc, stmt.elseif);
                break;
            case "statement_while":
            case "statement_until":
    ...
    function traverseNode(acc, node) {
        switch (node.kind) {
            case "program":
...
exports.foldExpressions = foldExpressions;
/**
 ...
 */
function forEachStatement(node, callback) {
    function traverseStatement(stmt) {
        callback(stmt);
        switch (stmt.kind) {
            case "statement_let":
 ...
 */
function foldStatements(node, acc, callback) {
    function traverseStatement(acc, stmt) {
        ...
        switch (stmt.kind) {
            ...
            case "statement_condition":
                ...
                if (stmt.falseStatements)
                    stmt.falseStatements.forEach((st) => (acc = traverseStatement(acc, st)));
                if (stmt.elseif)
                    acc = traverseStatement(acc, stmt.elseif);
                break;
            case "statement_while":
            ...
            case "statement_try_catch":
                stmt.statements.forEach((st) => (acc = traverseStatement(acc, st)));
                stmt.catchStatements.forEach((st) => (acc = traverseStatement(acc, st)));
                break;
            default:
                throw new Error("Unsupported statement");
        }
...
exports.foldStatements = foldStatements;
