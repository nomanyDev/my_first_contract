...
exports.allocate = exports.getAllocationOperationFromField = exports.getOperationSize = void 0;
const ALLOCATOR_RESERVE_BIT = 1;
const ALLOCATOR_RESERVE_REF = 1;
function getOperationSize(src) {
...
exports.getOperationSize = getOperationSize;
function getAllocationOperationFromField(src, structLoader) {
    // Reference types
    if (src.kind === "simple") {
...
exports.getAllocationOperationFromField = getAllocationOperationFromField;
function allocateSegment(ops, bits, refs) {
    const fields = [];
    let next = null;
    const used = { bits: 0, refs: 0 };
