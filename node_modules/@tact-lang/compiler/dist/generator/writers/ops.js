...
exports.ops = {
    ...
    reader: (type, ctx) => used(`$${type}$_load`, ctx),
    ...
    contractRouter: (type, kind) => `$${type}$_contract_router_${kind}`,
    // Router operations
    receiveEmpty: (type, kind) => `%$${type}$_${kind}_empty`,
    receiveType: (type, kind, msg) => `$${type}$_${kind}_binary_${msg}`,
    receiveAnyText: (type, kind) => `$${type}$_${kind}_any_text`,
    receiveText: (type, kind, hash) => `$${type}$_${kind}_text_${hash}`,
    receiveAny: (type, kind) => `$${type}$_${kind}_any`,
    receiveTypeBounce: (type, msg) => `$${type}$_receive_binary_bounce_${msg}`,
    receiveBounceAny: (type) => `$${type}$_receive_bounce`,
    // Functions
