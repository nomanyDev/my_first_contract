...
exports.writeStdlib = void 0;
const errors_1 = require("../../abi/errors");
const features_1 = require("../../config/features");
function writeStdlib(ctx) {
    //
    ...
    ctx.fun("__tact_verify_address", () => {
        ...
        ctx.body(() => {
            ctx.write(`
                throw_unless(${errors_1.contractErrors.invalidAddress.id}, address.slice_bits() == 267);
                var h = address.preload_uint(11);
            `);
            if ((0, features_1.enabledMasterchain)(ctx.ctx)) {
                ctx.write(`
                    throw_unless(${errors_1.contractErrors.invalidAddress.id}, (h == 1024) | (h == 1279));
                `);
            }
            else {
                ctx.write(`
                    throw_if(${errors_1.contractErrors.masterchainNotEnabled.id}, h == 1279);
                    throw_unless(${errors_1.contractErrors.invalidAddress.id}, h == 1024);
                `);
            }
            ctx.write(`
                return address;
    ...
    ctx.fun("__tact_not_null", () => {
        ...
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`throw_if(${errors_1.contractErrors.null.id}, null?(x)); return x;`);
        });
    });
    ...
    ctx.fun("__tact_dict_min", () => {
        ctx.signature(`(slice, slice, int) __tact_dict_min(cell dict, int key_len)`);
        ctx.context("stdlib");
        ctx.asm(`asm(dict key_len -> 1 0 2) "DICTMIN" "NULLSWAPIFNOT2"`);
    });
    ctx.fun("__tact_dict_min_ref", () => {
        ctx.signature(`(slice, cell, int) __tact_dict_min_ref(cell dict, int key_len)`);
        ctx.context("stdlib");
        ctx.asm(`asm(dict key_len -> 1 0 2) "DICTMINREF" "NULLSWAPIFNOT2"`);
    });
    ctx.fun("__tact_dict_next", () => {
        ctx.signature(`(slice, slice, int) __tact_dict_next(cell dict, int key_len, slice pivot)`);
        ctx.context("stdlib");
        ctx.asm(`asm(pivot dict key_len -> 1 0 2) "DICTGETNEXT" "NULLSWAPIFNOT2"`);
    });
    ctx.fun("__tact_dict_next_ref", () => {
        ctx.signature(`(slice, cell, int) __tact_dict_next_ref(cell dict, int key_len, slice pivot)`);
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_debug", () => {
        ctx.signature(`forall X -> () __tact_debug(X value, slice debug_print)`);
        ctx.flag("impure");
        ctx.context("stdlib");
    ...
    ctx.fun("__tact_debug_address", () => {
        ctx.signature(`() __tact_debug_address(slice address, slice debug_print)`);
        ctx.flag("impure");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_min_int_int", () => {
        ctx.signature(`(int, int, int) __tact_dict_min_int_int(cell d, int kl, int vl)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_next_int_int", () => {
        ctx.signature(`(int, int, int) __tact_dict_next_int_int(cell d, int kl, int pivot, int vl)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_min_int_uint", () => {
        ctx.signature(`(int, int, int) __tact_dict_min_int_uint(cell d, int kl, int vl)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_next_int_uint", () => {
        ctx.signature(`(int, int, int) __tact_dict_next_int_uint(cell d, int kl, int pivot, int vl)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_min_uint_int", () => {
        ctx.signature(`(int, int, int) __tact_dict_min_uint_int(cell d, int kl, int vl)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_next_uint_int", () => {
        ctx.signature(`(int, int, int) __tact_dict_next_uint_int(cell d, int kl, int pivot, int vl)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_min_uint_uint", () => {
        ctx.signature(`(int, int, int) __tact_dict_min_uint_uint(cell d, int kl, int vl)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_next_uint_uint", () => {
        ctx.signature(`(int, int, int) __tact_dict_next_uint_uint(cell d, int kl, int pivot, int vl)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_min_int_cell", () => {
        ctx.signature(`(int, cell, int) __tact_dict_min_int_cell(cell d, int kl)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_next_int_cell", () => {
        ctx.signature(`(int, cell, int) __tact_dict_next_int_cell(cell d, int kl, int pivot)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_min_uint_cell", () => {
        ctx.signature(`(int, cell, int) __tact_dict_min_uint_cell(cell d, int kl)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_next_uint_cell", () => {
        ctx.signature(`(int, cell, int) __tact_dict_next_uint_cell(cell d, int kl, int pivot)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_min_int_slice", () => {
        ctx.signature(`(int, slice, int) __tact_dict_min_int_slice(cell d, int kl)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_next_int_slice", () => {
        ctx.signature(`(int, slice, int) __tact_dict_next_int_slice(cell d, int kl, int pivot)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_min_uint_slice", () => {
        ctx.signature(`(int, slice, int) __tact_dict_min_uint_slice(cell d, int kl)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_next_uint_slice", () => {
        ctx.signature(`(int, slice, int) __tact_dict_next_uint_slice(cell d, int kl, int pivot)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_min_slice_int", () => {
        ctx.signature(`(slice, int, int) __tact_dict_min_slice_int(cell d, int kl, int vl)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_next_slice_int", () => {
        ctx.signature(`(slice, int, int) __tact_dict_next_slice_int(cell d, int kl, slice pivot, int vl)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_min_slice_uint", () => {
        ctx.signature(`(slice, int, int) __tact_dict_min_slice_uint(cell d, int kl, int vl)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun("__tact_dict_next_slice_uint", () => {
        ctx.signature(`(slice, int, int) __tact_dict_next_slice_uint(cell d, int kl, slice pivot, int vl)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun(`__tact_dict_min_slice_cell`, () => {
        ctx.signature(`(slice, cell, int) __tact_dict_min_slice_cell(cell d, int kl)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun(`__tact_dict_next_slice_cell`, () => {
        ctx.signature(`(slice, cell, int) __tact_dict_next_slice_cell(cell d, int kl, slice pivot)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun(`__tact_dict_min_slice_slice`, () => {
        ctx.signature(`(slice, slice, int) __tact_dict_min_slice_slice(cell d, int kl)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun(`__tact_dict_next_slice_slice`, () => {
        ctx.signature(`(slice, slice, int) __tact_dict_next_slice_slice(cell d, int kl, slice pivot)`);
        ctx.flag("inline");
        ctx.context("stdlib");
        ctx.body(() => {
            ctx.write(`
    ...
    ctx.fun(`__tact_dict_get_code`, () => {
        ...
        ctx.body(() => {
            ctx.write(`
                ...
                throw_unless(${errors_1.contractErrors.codeNotFound.id}, ok);
                return data;
            `);
        });
    });
    ...
    ctx.fun(`__tact_float_to_string`, () => {
        ...
        ctx.body(() => {
            ctx.write(`
                throw_if(${errors_1.contractErrors.invalidArgument.id}, (digits <= 0) | (digits > 77));
...
exports.writeStdlib = writeStdlib;
